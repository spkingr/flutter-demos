///
/// Article from: https://medium.com/flutter-community/make-3d-flip-animation-in-flutter-16c006bb3798
/// Code from: https://gist.github.com/hnvn/f1094fb4f6902078516cba78de9c868e
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: RichText(
                text: TextSpan(
                  text: "Flip widget from: ",
                  style: DefaultTextStyle.of(context).style.copyWith(fontSize: 16.0,),
                  children: <TextSpan>[
                    TextSpan(text: 'https://medium.com/flutter-community/make-3d-flip-animation-in-flutter-16c006bb3798', style: TextStyle(fontSize: 14.0, color: Colors.blue,)),
                    TextSpan(text: '\n'),
                    TextSpan(text: 'https://gist.github.com/hnvn/f1094fb4f6902078516cba78de9c868e', style: TextStyle(fontSize: 14.0, color: Colors.blue)),
                  ]
                )
              )
            ),
